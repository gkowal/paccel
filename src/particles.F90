...
!   y(n+1) = y(n) + [ d1 * Z1 + d2 * Z2 + d3 * Z3 ]
!
      xn(1:3) = x(1:3) + (d1 * z(1,1:3) + d2 * z(2,1:3) + d3 * z(3,1:3))
      pn(1:3) = p(1:3) + (d1 * z(1,4:6) + d2 * z(2,4:6) + d3 * z(3,4:6))
...
!
      ...
      zn(3,4:6) = dt * (a31 * a1(1:3) + a32 * a2(1:3) + a33 * a3(1:3)          &
                                                      + a34 * a4(1:3))
      zn(4,1:3) = dt * (a41 * u1(1:3) + a42 * u2(1:3) + a43 * u3(1:3)          &
                                                      + a44 * u4(1:3))
      zn(4,4:6) = dt * (a41 * a1(1:3) + a42 * a2(1:3) + a43 * a3(1:3)          &
                                                      + a44 * a4(1:3))
